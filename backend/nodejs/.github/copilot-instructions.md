...
## 10. Unit Test Generation Rule
- Generate unit tests for positive scenarios only.
- Do not include negative-case or failure-path test cases unless explicitly requested.
- Keep tests focused on expected successful behavior and valid inputs.
